...
VALUES  (UPPER('$Nom_utilisateur'), UPPER('$Prenom'), 'Délégué', '$newemail','$password',(SELECT promo.ID_Promotion from promo where UPPER(promo.Nom_promo)=UPPER('$ID_Promotion')), '$idcentr')";
$requetecreedelegue = $bdd->prepare($creedelegue);
$requetecreedelegue->execute();
}
$smarty->display('C:\www\Projet\Smarty\creer_delegue.tpl');
